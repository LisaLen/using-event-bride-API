...
def find_afterparties():
    ...
    if location and distance and measurement and query and sort:
        ...
        url = '''https://www.eventbriteapi.com/v3/events/search/?q={}&sort_by={}&location.address={}&location.within={}&'''.format(query, sort, location, distance)

        eventbr_token = os.environ['EVENTBRITE_TOKEN']
        
        payload = {'token': eventbr_token}
